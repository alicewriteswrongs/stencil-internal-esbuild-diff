...
const createTime = (e, t = "") => {
  ...
  updateElement = (e, t, a, o) => {
    const s = 11 === t.$elm$.nodeType && t.$elm$.host ? t.$elm$.host : t.$elm$,
      ...
      l = t.$attrs$ || EMPTY_OBJ;
    if (appData.BUILD.updatable)
      for (o in n) o in l || setAccessor(s, o, n[o], void 0, a, t.$flags$);
...
const createElm = (e, t, a, o) => {
    ...
    if (
      ...
      appData.BUILD.vdomText && null !== s.$text$)
    )
      n = s.$elm$ = doc.createTextNode(s.$text$);
    else if (appData.BUILD.slotRelocation && 1 & s.$flags$)
      n = s.$elm$ =
      ...
      if (
        (appData.BUILD.svg && !isSvgMode && (isSvgMode = "svg" === s.$tag$),
        (n = s.$elm$ =
          appData.BUILD.svg
            ? doc.createElementNS(
                isSvgMode
                ...
                appData.BUILD.slotRelocation && 2 & s.$flags$
                  ? "slot-fb"
                  : s.$tag$,
              )
            : doc.createElement(
        ...
        appData.BUILD.svg &&
          ...
          "foreignObject" === s.$tag$ &&
          (isSvgMode = !1),
        appData.BUILD.vdomAttribute && updateElement(null, s, isSvgMode),
        (appData.BUILD.shadowDom || appData.BUILD.scoped) &&
          null != scopeId &&
          n["s-si"] !== scopeId &&
          n.classList.add((n["s-si"] = scopeId)),
        s.$children$)
      )
        for (i = 0; i < s.$children$.length; ++i)
          (l = createElm(e, s, i, n)), l && n.appendChild(l);
      appData.BUILD.svg &&
        ("svg" === s.$tag$
          ? (isSvgMode = !1)
          : "foreignObject" === n.tagName && (isSvgMode = !0));
    }
    return (
      (n["s-hn"] = hostTagName),
      appData.BUILD.slotRelocation &&
  ...
  relocateToHostRoot = (e) => {
    ...
    if (null != t)
      for (const a of Array.from(e.childNodes))
        null != a["s-sh"] &&
        ...
        appData.BUILD.updatable && null !== s && null !== n
          ? ((e, t, a, o, s = !1) => {
              ...
              for (; r <= c && i <= h; )
                ...
                else if (null == D) D = o[--h];
                else if (isSameVnode($, m, s))
                  patch($, m, s), ($ = t[++r]), (m = o[++i]);
                else if (isSameVnode(u, D, s))
                  patch(u, D, s), (u = t[--c]), (D = o[--h]);
                else if (isSameVnode($, D, s))
                  !appData.BUILD.slotRelocation ||
                    ("slot" !== $.$tag$ && "slot" !== D.$tag$) ||
  ...
  renderVdom = (e, t, a = !1) => {
    ...
    if (
      ...
      appData.BUILD.slotRelocation &&
        ((contentRef = i["s-cr"]),
        (useNativeShadowDom = exports.supportsShadow && 0 != (1 & p.$flags$)),
        (checkSlotFallbackVisibility = !1)),
      patch(d, c, a),
      appData.BUILD.slotRelocation)
    ) {
...
const callRender = (e, t, a, o) => {
  ...
  initializeComponent = async (e, t, a, o) => {
    ...
    if (0 == (32 & t.$flags$)) {
      if (
        ((t.$flags$ |= 32),
        appData.BUILD.lazyLoad || appData.BUILD.hydrateClientSide)
      ) {
    ...
    (e.__appendChild = e.appendChild),
      (e.appendChild = function (e) {
        const t = (e["s-sn"] = getSlotName(e)),
          a = getHostSlotNode(this.childNodes, t);
        if (a) {
    ...
    e.prepend = function (...e) {
      e.forEach((e) => {
        ...
        const a = (e["s-sn"] = getSlotName(e)),
          o = getHostSlotNode(this.childNodes, a);
        if (o) {

...
export interface ComponentCompilerProperty
  extends ComponentCompilerStaticProperty {
  name: string;
  internal: boolean;
}
...
export type ComponentCompilerPropertyType =
  | "any"
  | "string"
  | "boolean"
  | "number"
 ...
 */
export type ComponentCompilerTypeReferences = Record<
  string,
...
export type InitServerProcess = (
  sendMsg: (msg: DevServerMessage) => void,
...
export interface CompilerWorkerContext {
  ...
  transformCssToEsm(
    input: TransformCssToEsmInput,
  ): Promise<TransformCssToEsmOutput>;
}
/**

/*
 Stencil Client Platform v4.12.0-dev.1706551849.8760468 | MIT Licensed | https://stenciljs.com
 */
...
function queryNonceMetaTagContent(doc2) {
  ...
  return (_c =
    (_b =
      (_a2 = doc2.head) == null
        ? void 0
        : _a2.querySelector('meta[name="csp-nonce"]')) == null
      ? void 0
...
var initializeClientHydrate = (hostElm, tagName, hostId, hostRef) => {
  ...
  if (!plt.$orgLocNodes$) {
    initializeDocumentHydrate(
      doc.body,
      (plt.$orgLocNodes$ = /* @__PURE__ */ new Map()),
    );
  }
  ...
  if (node.nodeType === 1 /* ElementNode */) {
    ...
    if (childIdSplt[1] === hostId || childIdSplt[1] === "0") {
      ...
      if (childNodeType === TEXT_NODE_ID) {
        ...
        if (
          childVNode.$elm$ &&
          childVNode.$elm$.nodeType === 3 /* TextNode */
        ) {
    ...
    if (typeof style === "string") {
      ...
      if (!appliedStyles) {
        rootAppliedStyles.set(
          styleContainerNode,
          (appliedStyles = /* @__PURE__ */ new Set()),
        );
      }
      if (!appliedStyles.has(scopeId2)) {
        if (
          ...
          styleElm.innerHTML = style;
          const nonce =
            (_a2 = plt.$nonce$) != null ? _a2 : queryNonceMetaTagContent(doc);
          if (nonce != null) {
...
var attachStyles = (hostRef) => {
  ...
  if (
    ...
    flags & 10 /* needsScopedEncapsulation */
  ) {
    elm["s-sc"] = scopeId2;
...
var getScopeId = (cmp, mode) =>
  "sc-" +
  (BUILD.mode && mode && cmp.$flags$ & 32 /* hasMode */
    ? cmp.$tagName$ + "-" + mode
    : cmp.$tagName$);
...
var createElm = (oldParentVNode, newParentVNode, childIndex, parentElm) => {
  ...
  if (BUILD.vdomText && newVNode2.$text$ !== null) {
    ...
    newVNode2.$flags$ & 1 /* isSlotReference */
  ) {
    elm = newVNode2.$elm$ =
    ...
    elm = newVNode2.$elm$ = BUILD.svg
      ? doc.createElementNS(
          ...
          BUILD.slotRelocation && newVNode2.$flags$ & 2 /* isSlotFallback */
            ? "slot-fb"
            : newVNode2.$tag$,
        )
      : doc.createElement(
        ...
        for (const siblingNode of childNodes) {
          if (siblingNode !== childNode) {
            if (siblingNode["s-hn"] !== childNode["s-hn"] || slotName !== "") {
              if (
                siblingNode.nodeType === 1 /* ElementNode */ &&
              ...
              if (
                siblingNode.nodeType === 1 /* ElementNode */ ||
                (siblingNode.nodeType === 3 /* TextNode */ &&
      ...
      for (const relocateData of relocateNodes) {
        ...
        if (slotRefNode) {
          ...
          if (
            !BUILD.experimentalSlotFixes ||
            (insertBeforeNode &&
              insertBeforeNode.nodeType === 1) /* ElementNode */
          ) {
            let orgLocationNode =
              (_a2 = nodeToRelocate["s-ol"]) == null
                ? void 0
                : _a2.previousSibling;
...
var setValue = (ref, propName, newVal, cmpMeta) => {
  ...
  if (
    (!BUILD.lazyLoad ||
      !((flags & 8) /* isConstructingInstance */) ||
      oldVal === void 0) &&
    didValueChange
  ) {
...
More information: https://stenciljs.com/docs/properties#prop-mutability`,
        ...
        Object.defineProperty(prototype, memberName, {
          value(...args) {
            var _a3;
            const ref = getHostRef(this);
            return (_a3 = ref == null ? void 0 : ref.$onInstancePromise$) ==
              null
              ? void 0
              : _a3.then(() => {
                  var _a4;
                  return (_a4 = ref.$lazyInstance$) == null
                    ? void 0
                    : _a4[memberName](...args);
                });
          },
    ...
    if (
      ...
      (!BUILD.lazyLoad || flags & 1) /* isElementConstructor */
    ) {
        ...
        plt.jmp(() => {
          ...
          if (this.hasOwnProperty(propName)) {
            ...
            if (
              ...
              const instance = BUILD.lazyLoad ? hostRef.$lazyInstance$ : elm;
              const entry =
                (_a3 = cmpMeta.$watchers$) == null ? void 0 : _a3[attrName];
              entry == null
                ? void 0
      ...
      Cstr.observedAttributes = Array.from(
        /* @__PURE__ */ new Set([
          ...Object.keys((_a2 = cmpMeta.$watchers$) != null ? _a2 : {}),
          ...members
            ...
            .map(([propName, m]) => {
              ...
              if (BUILD.reflect && m[0] & 512 /* ReflectAttr */) {
                (_a3 = cmpMeta.$attrsToReflect$) == null
                  ? void 0
                  : _a3.push([propName, attrName]);
              }
              return attrName;
            }),
        ]),
  ...
  if ((hostRef.$flags$ & 32) /* hasInitializedComponent */ === 0) {
    ...
    if (BUILD.lazyLoad || BUILD.hydrateClientSide) {
      ...
      customElements
        ...
        .then(() => (hostRef.$flags$ |= 128) /* isWatchReady */);
    }
...
var MockAttributeMap = class {
  ...
  removeNamedItemNS(attr) {
    for (let i2 = 0, ii = this.__items.length; i2 < ii; i2++) {
      if (
        this.__items[i2].name === attr.name &&
        this.__items[i2].namespaceURI === attr.namespaceURI
      ) {
  ...
  composedPath() {
    ...
    while (currentElement) {
      ...
      if (
        ...
        currentElement.nodeName === "#document" /* DOCUMENT_NODE */
      ) {
...
var Tokenizer = class {
  ...
  _matchNamedCharacterReference(cp) {
    ...
    for (
      let i2 = 0, current = decode_data_html_default[0];
      i2 >= 0;
      cp = this._consume()
    ) {
...
var defaultTreeAdapter = {
  ...
  insertBefore(parentNode, newNode, referenceNode2) {
    const insertionIdx = parentNode.childNodes.indexOf(referenceNode2);
  ...
  setDocumentType(document2, name, publicId, systemId) {
    const doctypeNode = document2.childNodes.find(
  ...
  insertTextBefore(parentNode, text, referenceNode2) {
    const prevNode =
      parentNode.childNodes[parentNode.childNodes.indexOf(referenceNode2) - 1];
    ...
    for (let i2 = this.openElements.stackTop; i2 >= 0; i2--) {
      ...
      switch (this.openElements.tagIDs[i2]) {
        ...
        case TAG_ID.TABLE: {
          ...
          return {
            parent: this.openElements.items[i2 - 1],
            beforeElement: null,
          };
        }
        default:
  ...
  const treeAdapter = {
    ...
    setDocumentType(doc2, name, publicId, systemId) {
      let doctypeNode = doc2.childNodes.find(
        (n) => n.nodeType === 10 /* DOCUMENT_TYPE_NODE */,
      );
      if (doctypeNode == null) {
    ...
    insertTextBefore(parentNode, text, referenceNode2) {
      const prevNode =
        parentNode.childNodes[
          parentNode.childNodes.indexOf(referenceNode2) - 1
        ];
...
var jquery_default =
  ...
  (function (global, factory) {
    ...
    function (window2, noGlobal) {
      ...
      jQuery.fn = jQuery.prototype = {
        ...
        map: function (callback) {
          return this.pushStack(
            jQuery.map(this, function (elem, i3) {
        ...
        even: function () {
          return this.pushStack(
            jQuery.grep(this, function (_elem, i3) {
              return (i3 + 1) % 2;
            }),
          );
        },
      ...
      var matches2 =
        documentElement.matches || documentElement.msMatchesSelector;
      ...
      function sortOrder(a, b) {
        ...
        if (compare & 1) {
          if (
            a == document2 ||
            (a.ownerDocument == document2 && jQuery.contains(document2, a))
          ) {
            return -1;
          }
          if (
            b == document2 ||
            (b.ownerDocument == document2 && jQuery.contains(document2, b))
          ) {
            return 1;
          }
          return 0;
          ...
          if (documentIsHTML) {
            ...
            if (
              ...
              if (
                ...
                while (i3--) {
                  groups[i3] =
                    (nid ? "#" + nid : ":scope") + " " + toSelector(groups[i3]);
                }
      ...
      function setDocument(node) {
        var subWindow,
          doc2 = node ? node.ownerDocument || node : document2;
          ...
          if (seed) {
            if (postFinder || preFilter2) {
              ...
              while (i3--) {
                if (
                  (elem = matcherOut[i3]) &&
                  (temp = postFinder ? indexOf.call(seed, elem) : preMap[i3]) >
                    -1
                ) {
      ...
      function matcherFromTokens(tokens) {
        ...
        for (; i3 < len; i3++) {
          if ((matcher = jQuery.expr.relative[tokens[i3].type])) {
            matchers = [addCombinator(elementMatcher(matchers), matcher)];
          } else {
            matcher = jQuery.expr.filter[tokens[i3].type].apply(
              null,
              tokens[i3].matches,
            );
    ...
    if (typeof textContent === "string") {
      ...
      if (trimmedTextContent === "") {
        ...
        if (textContentLength > 0) {
          const parentTagName =
            node.parentNode != null &&
            node.parentNode.nodeType === 1 /* ELEMENT_NODE */
...
var REMOVE_EMPTY_ATTR = /* @__PURE__ */ new Set([
  "class",
  "dir",
  "id",
  "lang",
...
var MockDocument = class _MockDocument extends MockHTMLElement {
  ...
  set documentElement(documentElement) {
    for (let i2 = this.childNodes.length - 1; i2 >= 0; i2--) {
      if (this.childNodes[i2].nodeType !== 10 /* DOCUMENT_TYPE_NODE */) {
...
function setOwnerDocument(elm, ownerDocument) {
  for (let i2 = 0, ii = elm.childNodes.length; i2 < ii; i2++) {
    ...
    if (elm.childNodes[i2].nodeType === 1 /* ELEMENT_NODE */) {
  ...
  if (BUILD.experimentalScopedSlotChanges) {
        ...
        const textContent = slotRefNodes
          .map((node) => {
            ...
            while (slotContent && slotContent["s-sn"] === node["s-sn"]) {
              if (
                slotContent.nodeType === 3 /* TEXT_NODE */ ||
                slotContent.nodeType === 1 /* ELEMENT_NODE */
              ) {
                text.push(
                  (_b =
                    (_a2 = slotContent.textContent) == null
                      ? void 0
                      : _a2.trim()) != null
                    ? _b
                    : "",
    ...
    Object.defineProperty(hostElementPrototype, "textContent", {
      get() {
        ...
        if (
          ((_a2 = slotNode == null ? void 0 : slotNode.nextSibling) == null
            ? void 0
            : _a2.nodeType) === 3 /* TEXT_NODE */
        ) {
  ...
  if (cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
    ...
    Object.defineProperty(elm, "childNodes", {
      get() {
        ...
        if (
          (plt.$flags$ & 1) /* isTmpDisconnected */ === 0 &&
...
var proxyCustomElement = (Cstr, compactMeta) => {
      ...
      if (supportsShadow) {
        if (BUILD.shadowDelegatesFocus) {
          this.attachShadow({
            mode: "open",
            delegatesFocus: !!(
              (cmpMeta.$flags$ & 16) /* shadowDelegatesFocus */
            ),
          });
        } else {
  ...
  return proxyComponent(
    Cstr,
    cmpMeta,
    1 /* isElementConstructor */ | 2 /* proxyState */,
  );
};
...
var bootstrapLazy = (lazyBundles, options = {}) => {
  ...
  const styles2 = /* @__PURE__ */ doc.querySelectorAll(
    `[${HYDRATED_STYLE_ID}]`,
  );
  let appLoadFallback;
      ...
      if (orgLocationNode != null && orgLocationNode["s-nr"]) {
        ...
        if (hostId == null) {
          ...
          if (nodeRef.nodeType === 1 /* ElementNode */) {
            ...
            if (hostId === 0) {
              const textContent =
                (_a2 = nodeRef.nodeValue) == null ? void 0 : _a2.trim();
              if (textContent === "") {
...
var loadModule = (cmpMeta, hostRef, hmrVersionId) => {
  ...
  return /* @vite-ignore */ /* webpackInclude: /\.entry\.js$/ */ /* webpackExclude: /\.system\.entry\.js$/ */ /* webpackMode: "lazy" */ globImport_entry_js(

/*
 Stencil Client Platform v4.10.0-dev.1705682654.cce60df | MIT Licensed | https://stenciljs.com
 */
...
function queryNonceMetaTagContent(doc2) {
  var _a2, _b, _c;
  return (_c = (_b = (_a2 = doc2.head) == null ? void 0 : _a2.querySelector('meta[name="csp-nonce"]')) == null ? void 0 : _b.getAttribute("content")) != null ? _c : void 0;
}
    ...
    if (typeof style === "string") {
      ...
      if (!appliedStyles.has(scopeId2)) {
        if (BUILD.hydrateClientSide && styleContainerNode.host && (styleElm = styleContainerNode.querySelector(`[${HYDRATED_STYLE_ID}="${scopeId2}"]`))) {
          ...
          styleElm.innerHTML = style;
          const nonce = (_a2 = plt.$nonce$) != null ? _a2 : queryNonceMetaTagContent(doc);
          if (nonce != null) {
        ...
        for (const siblingNode of childNodes) {
          if (siblingNode !== childNode) {
            if (siblingNode["s-hn"] !== childNode["s-hn"] || slotName !== "") {
              if (siblingNode.nodeType === 1 /* ElementNode */ && (slotName === siblingNode.getAttribute("slot") || slotName === siblingNode["s-sn"])) {
      ...
      for (const relocateData of relocateNodes) {
        ...
        if (slotRefNode) {
          ...
          if (!BUILD.experimentalSlotFixes || insertBeforeNode && insertBeforeNode.nodeType === 1 /* ElementNode */) {
            let orgLocationNode = (_a2 = nodeToRelocate["s-ol"]) == null ? void 0 : _a2.previousSibling;
...
var defaultTreeAdapter = {
  ...
  insertTextBefore(parentNode, text, referenceNode2) {
    ...
    if (prevNode && defaultTreeAdapter.isTextNode(prevNode)) {
      ...
      defaultTreeAdapter.insertBefore(parentNode, createTextNode(text), referenceNode2);
    }
  },
  ...
  */
  function(global, factory) {
    ...
    function DOMEval(code, node, doc2) {
      doc2 = doc2 || document2;
      var i3, script = doc2.createElement("script");
      script.text = code;
      if (node) {
    ...
    jQuery.extend({
      ...
      grep: function(elems, callback, invert) {
        var callbackInverse, matches3 = [], i3 = 0, length = elems.length, callbackExpect = !invert;
        for (; i3 < length; i3++) {
    ...
    function matcherFromTokens(tokens) {
      var checkContext, matcher, j, len = tokens.length, leadingRelative = jQuery.expr.relative[tokens[0].type], implicitRelative = leadingRelative || jQuery.expr.relative[" "], i3 = leadingRelative ? 1 : 0, matchContext = addCombinator(function(elem) {
      ...
      for (; i3 < len; i3++) {
        if (matcher = jQuery.expr.relative[tokens[i3].type]) {
          ...
          matcher = jQuery.expr.filter[tokens[i3].type].apply(null, tokens[i3].matches);
    ...
    function matcherFromGroupMatchers(elementMatchers, setMatchers) {
      var bySet = setMatchers.length > 0, byElement = elementMatchers.length > 0, superMatcher = function(seed, context, xml, results, outermost) {
        var elem, j, matcher, matchedCount = 0, i3 = "0", unmatched = seed && [], setMatched = [], contextBackup = outermostContext, elems = seed || byElement && jQuery.expr.find.TAG("*", outermost), dirrunsUnique = dirruns += contextBackup == null ? 1 : Math.random() || 0.1;
        if (outermost) {
  ...
  if (BUILD.experimentalScopedSlotChanges) {
        ...
        const textContent = slotRefNodes.map((node) => {
          ...
          while (slotContent && slotContent["s-sn"] === node["s-sn"]) {
            if (slotContent.nodeType === 3 /* TEXT_NODE */ || slotContent.nodeType === 1 /* ELEMENT_NODE */) {
              text.push((_b = (_a2 = slotContent.textContent) == null ? void 0 : _a2.trim()) != null ? _b : "");
            }
    ...
    Object.defineProperty(hostElementPrototype, "textContent", {
      get() {
        ...
        if (((_a2 = slotNode == null ? void 0 : slotNode.nextSibling) == null ? void 0 : _a2.nodeType) === 3 /* TEXT_NODE */) {

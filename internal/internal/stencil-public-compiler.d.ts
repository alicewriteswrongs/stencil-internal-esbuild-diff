...
export interface CompilerSystem {
  ...
  rename(
    oldPath: string,
    newPath: string,
  ): Promise<CompilerSystemRenameResults>;
  resolveModuleId?(
    opts: ResolveModuleIdOptions,
  ): Promise<ResolveModuleIdResults>;
  ...
  writeFile(
    p: string,
    content: string,
  ): Promise<CompilerSystemWriteFileResults>;
  /**
   * SYNC! Does not throw.
   */
...
export interface BuildOnEvents {
  ...
  on(
    eventName: CompilerEventFileAdd,
    cb: (path: string) => void,
  ): BuildOnEventRemove;
  on(
    eventName: CompilerEventFileDelete,
    cb: (path: string) => void,
  ): BuildOnEventRemove;
  on(
    eventName: CompilerEventFileUpdate,
    cb: (path: string) => void,
  ): BuildOnEventRemove;
  on(
    eventName: CompilerEventDirAdd,
    cb: (path: string) => void,
  ): BuildOnEventRemove;
  on(
    eventName: CompilerEventDirDelete,
    cb: (path: string) => void,
  ): BuildOnEventRemove;
  on(
  ...
  on(
    eventName: CompilerEventBuildLog,
    cb: (buildLog: BuildLog) => void,
  ): BuildOnEventRemove;
...
export interface BuildEmitEvents {
  ...
  emit(
    eventName: CompilerEventBuildNoChange,
    buildNoChange: BuildNoChangeResults,
  ): void;
...
export interface OutputTargetDistCollection
  extends OutputTargetValidationConfig {
 ...
 */
export declare const CustomElementsExportBehaviorOptions: readonly [
  "default",
 ...
 */
export type CustomElementsExportBehavior =
  (typeof CustomElementsExportBehaviorOptions)[number];
export interface OutputTargetDistCustomElements
  extends OutputTargetValidationConfig {

...
var lo,
  ...
  bn = It(() => {
    ...
    (lo = (e) => {
      ...
      (gn = "-shadowcsscontext"),
      (St = ")(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))?([^,{]*)"),
      (po = new RegExp("(" + Ce + St, "gim")),
      (fo = new RegExp("(" + gn + St, "gim")),
      (uo = new RegExp("(" + $n + St, "gim")),
      (X = Ce + "-no-combinator"),
      (mo = /-shadowcsshost-no-combinator([^\s]*)/),
      ($o = [/::shadow/g, /::content/g]),
      (go = "([>\\s~+[.,{:][\\s\\S]*)?$"),
      ...
      (yn = (e, t, n) => e + t.replace(Ce, "") + n),
      (Io = (e) => hn(e, po, yn)),
      (ko = (e, t, n) =>
        t.indexOf(Ce) > -1 ? yn(e, t, n) : e + t + n + ", " + t + " " + e + n),
      (Po = (e, t) => {
        let n = "." + t + " > ",
          o = [];
        return (
      ...
      (wo = (e) => hn(e, fo, ko)),
      (Ho = (e) => $o.reduce((t, n) => t.replace(n, " "), e)),
      (Ao = (e) => {
        let t = /\[/g,
          n = /\]/g;
        return (
      ...
      (_o = (e, t) => !Ao(t).test(e)),
      (xn = (e, t) =>
        e.replace(Eo, (n, o = "", s, i = "", a = "") => o + t + i + a)),
      (Uo = (e, t, n) => {
        if (((Ye.lastIndex = 0), Ye.test(e))) {
          let o = `.${n}`;
          return e.replace(mo, (s, i) => xn(i, o)).replace(Ye, o + " ");
        }
        return t + " " + e;
      }),
      (Mo = (e, t, n) => {
          ...
          return (
            i.selector[0] !== "@"
              ...
              : (i.selector.startsWith("@media") ||
                ...
                (c = Cn(i.content, t, n, o, s)),
            { selector: a.replace(/\s{2,}/g, " ").trim(), content: c }
          );
        })),
      (jo = (e, t, n, o, s) => {
        (e = Oo(e)), (e = Io(e)), (e = wo(e));
        let i = Po(e, o);
        return (
          (e = i.cssText),
          (e = Ho(e)),
          ...
          (e = e.replace(/>\s*\*\s+([^{, ]+)/gm, " $1 ")),
          {
            ...
            slottedSelectors: i.selectors.map((a) => ({
              orgSelector: Tt(a.orgSelector, n),
              updatedSelector: Tt(a.updatedSelector, n),
            })),
          }
        );
      }),
      (Tt = (e, t) => e.replace(/-shadowcsshost-no-combinator/g, `.${t}`)),
      (zo = (e, t, n) => {
        let o = t + "-h",
          s = t + "-s",
          i = So(e);
        ...
        return (
          ...
          c.slottedSelectors.forEach((l) => {
            let d = new RegExp(Mt(l.orgSelector), "g");
...
var _t = (e) => e != null;
var Q = (e) => ((e = typeof e), e === "object" || e === "function");
var Ut = (e) =>
  !!e &&
...
var Oe = "r",
  ...
  V = "sty-id",
  B = "c-id",
  Wt = "{visibility:hidden}.hydrated{visibility:inherit}",
  Pe = "slot-fb{display:contents}slot-fb[hidden]{display:none}",
...
var A = (e, t, ...n) => {
  ...
  we = (e) => e && e.$tag$ === at,
  Qn = {
    forEach: (e, t) => e.map(Jt).forEach(t),
    map: (e, t) => e.map(Jt).map(t).map(Vn),
  },
  Jt = (e) => ({
    vattrs: e.$attrs$,
...
var Yt = (e, t, n, o) => {
    let s = R("hydrateClient", t),
      ...
      d = (o.$vnode$ = j(t, null));
    $.$orgLocNodes$ || ct(T.body, ($.$orgLocNodes$ = new Map())),
      (e[Y] = n),
      e.removeAttribute(Y),
      lt(d, a, c, l, e, e, n),
      a.map((p) => {
    ...
    ? r.propBoolean && t & 4
      ...
      : r.propNumber && t & 2
        ...
        : r.propString && t & 1
          ...
          : e
    : e;
var Ae = (e) => (r.lazyLoad ? g(e).$hostElement$ : e);
var Kt = (e, t, n) => {
    let o = Ae(e);
    return {
      emit: (s) => (
...
var ee,
    ...
    return (
      ...
      r.slotRelocation &&
        ...
        l &&
          l.$tag$ === s.$tag$ &&
          e.$elm$ &&
          (r.experimentalSlotFixes ? nn(e.$elm$) : $e(e.$elm$, !1))),
      a
    );
  },
  nn = (e) => {
    ...
    if (t != null) {
      let n = Array.from(t.childNodes).find((s) => s["s-cr"]),
        o = Array.from(e.childNodes);
      for (let s of n ? o.reverse() : o)
        s["s-sh"] != null &&
          (t.insertBefore(s, n != null ? n : null),
          (s["s-sh"] = void 0),
          (We = !0));
    }
    $.$flags$ &= -2;
    ...
    for (let o = t; o <= n; ++o) {
      ...
      if (s) {
        ...
        ln(s),
          i &&
            (r.slotRelocation &&
              ((je = !0), i["s-ol"] ? i["s-ol"].remove() : $e(i, !0)),
            i.remove());
      }
    }
  },
    ...
    for (; i <= d && a <= u; )
      if (p == null) p = t[++i];
        ...
        r.vdomKey && c >= 0
          ...
          y &&
            (r.slotRelocation
              ? rn(p.$elm$).insertBefore(y, gt(p.$elm$))
              : p.$elm$.parentNode.insertBefore(y, p.$elm$));
      }
    i > d
      ? on(e, o[u + 1] == null ? null : o[u + 1].$elm$, n, o, a, u)
      : r.updatable && a > u && sn(t, i, d);
  },
  Be = (e, t, n = !1) =>
    e.$tag$ === t.$tag$
      ...
      : !1,
  gt = (e) => (e && e["s-ol"]) || e,
  rn = (e) => (e["s-ol"] ? e["s-ol"] : e).parentNode,
  te = (e, t, n = !1) => {
    let o = (t.$elm$ = e.$elm$),
      s = e.$children$,
      i = t.$children$,
        ...
        (r.vdomAttribute || r.reflect) &&
          (r.slot && a === "slot" && !$t
            ? r.experimentalSlotFixes &&
              e.$name$ !== t.$name$ &&
              ((t.$elm$["s-sn"] = t.$name$ || ""), nn(t.$elm$.parentElement))
            : ut(e, t, O)),
        r.updatable && s !== null && i !== null
          ...
          : i !== null
            ? (r.updatable &&
                ...
                e.$text$ !== null &&
                (o.textContent = ""),
              on(o, null, t, i, 0, i.length - 1))
            : r.updatable && s !== null && sn(s, 0, s.length - 1),
        r.svg && O && a === "svg" && (O = !1))
  ...
  ye = (e, t, n = !1) => {
    ...
    let o = e.$hostElement$,
      ...
      a = we(t) ? t : A(null, null, t);
    if (((W = o.tagName), r.isDev && Array.isArray(t) && t.some(we)))
      throw new Error(
    ...
    if (
      ...
      ($t = D && (s.$flags$ & 1) !== 0),
      r.slotRelocation && ((mt = o["s-cr"]), (je = !1)),
      te(i, a, n),
      r.slotRelocation)
    ) {
      if ((($.$flags$ |= 1), We)) {
      ...
      je && he(a.$elm$), ($.$flags$ &= -2), (U.length = 0);
    }
...
var xt = (e, t) => {
  ...
  oe = (e, t) => {
    ...
    xt(e, e.$ancestorComponent$);
    let n = () => ro(e, t);
    return r.taskQueue ? mn(n) : n();
  },
  ro = (e, t) => {
    let n = e.$hostElement$,
    ...
    return (
      ...
      r.cmpWillRender && (i = cn(i, () => I(s, "componentWillRender"))),
      o(),
      cn(i, () => ao(e, s, t))
    );
  },
  cn = (e, t) => (io(e) ? e.then(t) : t()),
  io = (e) =>
  ...
  ao = async (e, t, n) => {
    ...
    if (
      ...
      r.hydrateServerSide ? await dn(e, t, o, n) : dn(e, t, o, n),
      r.isDev &&
        ((e.$renderCount$ =
    ...
    r.cmpDidRender &&
      ...
      e.$flags$ & 64
        ? (r.cmpDidUpdate &&
          ...
          o())
        : ((e.$flags$ |= 64),
          r.asyncLoading && r.cssAnnotations && fn(n),
          r.cmpDidLoad &&
  ...
  se = (e) => {
    if (r.updatable && (yt.isBrowser || yt.isTesting)) {
      let t = g(e),
  ...
  Je = (e) => {
    r.cssAnnotations && fn(T.documentElement),
      r.asyncQueue && ($.$flags$ |= 2),
      xe(() => _e(N, "appload", { detail: { namespace: pe } })),
      r.profile &&
        performance.measure &&
        performance.measure(
...
var re = (e, t) => g(e).$instanceValues$.get(t),
  ie = (e, t, n, o) => {
    let s = g(e),
      ...
      r.hostListener &&
        ...
        r.lazyLoad
          ? t != null && t.$lazyInstance$
            ...
            : t != null &&
              t.$onReadyPromise$ &&
              t.$onReadyPromise$.then(() => Dt(t.$lazyInstance$))
          : Dt(e);
    }
  };
import { NODE_TYPES as Ke } from "../../mock-doc/index.js";
var Qe = (e, t) => {
    Se(e), Re(e), Yo(e), Jo(e), Ko(e), qo(e), Xo(e), De(e), Ee(e, t), Fo(e);
  },
  Se = (e) => {
    let t = e.cloneNode;
  ...
  Et = (e) => {
    ...
    for (let n of Array.from(e))
      n["s-sr"] && t.push(n), t.push(...Et(n.childNodes));
    return t;
  },
  Sn = (e) => e["s-sn"] || (e.nodeType === 1 && e.getAttribute("slot")) || "",
  le = (e, t) => {
    let n = 0,
      o;
    for (; n < e.length; n++)
...
var Rn = (e, t) => {
    customElements.define(t[1], vt(e, t));
  },
  vt = (e, t) => {
    ...
    r.member && (n.$members$ = t[2]),
      ...
      r.experimentalSlotFixes
        ? r.scoped && n.$flags$ & 2 && Qe(e.prototype, n)
        : (r.slotChildNodesFix && Ee(e.prototype, n),
...
var Nn = (e, t = {}) => {
  var y;
  r.profile && performance.mark && performance.mark("st:app:start"), zt();
  let n = R("bootstrapLazy"),
    ...
    d = [],
    p = T.querySelectorAll(`[${V}]`),
    f,
    u = !0,
    m = 0;
  if (
    (Object.assign($, t),
    ($.$resourcesUrl$ = new URL(t.resourcesUrl || "./", T.baseURI).href),
    r.asyncQueue && t.syncQueue && ($.$flags$ |= 4),
    r.hydrateClientSide && ($.$flags$ |= 2),
    r.hydrateClientSide && r.shadowDom)
  )
    for (; m < p.length; m++) G(p[m].getAttribute(V), Vt(p[m].innerHTML), !0);
  let h = !1;
  if (
    (e.map((x) => {
      x[1].map((S) => {
        ...
        r.experimentalSlotFixes
          ? r.scoped && C.$flags$ & 2 && Qe(w.prototype, C)
          : (r.slotChildNodesFix && Ee(w.prototype, C),
            r.cloneNodeFix && Se(w.prototype),
            r.appendChildSlotFix && Re(w.prototype),
            r.scopedSlotTextContentFix && C.$flags$ & 2 && De(w.prototype)),
          r.formAssociated && C.$flags$ & 64 && (w.formAssociated = !0),
          r.hotModuleReplacement &&
            (w.prototype["s-hmr"] = function (E) {
              En(this, C, E);
            }),
          (C.$lazyBundleId$ = x[0]),
          !s.includes(de) &&
            !i.get(de) &&
            (o.push(de), i.define(de, F(w, C, 1)));
      });
    }),
    o.length > 0 &&
      (h && (l.innerHTML += Pe),
  ...
  (u = !1),
    d.length
      ...
      : r.profile
        ? $.jmp(() => (f = setTimeout(Je, 30, "timeout")))
        : $.jmp(() => (f = setTimeout(Je, 30))),
    n();
};
var vn = (e, t) => t;
var K = (e, t, n, o) => {
    r.hostListener &&
      ...
      (r.hostListenerTargetParent &&
        (o
          ...
          : (n = n.filter(([s]) => !(s & 32)))),
      n.map(([s, i, a]) => {
        let c = r.hostListenerTarget ? Vo(e, s) : e,
          l = Qo(t, a),
          d = Zo(s);
        $.ael(c, i, l, d),
      ...
      : r.hostListenerTargetWindow && t & 8
        ...
        : r.hostListenerTargetBody && t & 16
          ...
          : r.hostListenerTargetParent && t & 32
            ...
            : e,
  Zo = (e) =>
    Ln ? { passive: (e & 1) !== 0, capture: (e & 2) !== 0 } : (e & 2) !== 0;
var Lt = (e) => ($.$nonce$ = e);
var Ve = (e, t) => {
    if (e != null) {
...
function os(e, t, n, o, s) {
  ...
  function m() {
    if ((global.clearTimeout(f), a.clear(), i.clear(), !u)) {
      u = !0;
      try {
        t.clientHydrateAnnotations && Ve(e.document, t.staticComponents),
    ...
    let k = function () {
      ...
      Ze = function (b) {
        if (b != null && b.nodeType === 1) {
          E(b);
          let H = b.children;
          for (let L = 0, Ne = H.length; L < Ne; L++) Ze(H[L]);
        }
      },
      Ge = function (b) {
        return (
          a.delete(b),
          wn(b, t) && n.hydratedCount < t.maxHydrateCount && !i.has(b) && An(b)
...
var _n,
  ...
  Ot = new WeakMap(),
  g = (e) => Ot.get(e),
  uc = (e, t) => Ot.set((t.$lazyInstance$ = e), t),
  ce = (e, t) => {
    let n = {
      $flags$: 0,
      $cmpMeta$: t,
  ...
  yt = { isDev: !1, isBrowser: !1, isServer: !0, isTesting: !1 },
  z = new Map(),
  dt = [];
export {
  r as BUILD,
  ...
  T as doc,
  Dn as forceModeUpdate,
  se as forceUpdate,
  Pt as getAssetPath,
  Ae as getElement,
  g as getHostRef,
  Xt as getMode,
  pn as getRenderingRef,
  re as getValue,
  es as h,
  os as hydrateApp,
  Ve as insertVdomAnnotations,

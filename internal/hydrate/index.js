...
const createTime = (e, t = "") => {
  ...
  updateElement = (e, t, o, n) => {
    const s = 11 === t.$elm$.nodeType && t.$elm$.host ? t.$elm$.host : t.$elm$,
      ...
      a = t.$attrs$ || EMPTY_OBJ;
    if (BUILD.updatable)
      for (n of sortedAttrNames(Object.keys(l)))
        n in a || setAccessor(s, n, l[n], void 0, o, t.$flags$);
    for (n of sortedAttrNames(Object.keys(a)))
      setAccessor(s, n, l[n], a[n], o, t.$flags$);
  };
let scopeId,
  contentRef,
  hostTagName,
...
const createElm = (e, t, o, n) => {
    ...
    if (
      ...
      BUILD.isDev &&
        l.$elm$ &&
        consoleDevError(
          `The JSX ${null !== l.$text$ ? `"${l.$text$}" text` : `"${l.$tag$}" element`} node should not be shared within the same renderer. The renderer caches element lookups in order to improve performance. However, a side effect from this is that the exact same JSX node should not be reused. For more information please see https://stenciljs.com/docs/templating-jsx#avoid-shared-jsx-nodes`,
        ),
      BUILD.vdomText && null !== l.$text$)
    )
      a = l.$elm$ = doc.createTextNode(l.$text$);
    else if (BUILD.slotRelocation && 1 & l.$flags$)
      a = l.$elm$ =
        BUILD.isDebug || BUILD.hydrateServerSide
          ? slotReferenceDebugNode(l)
          : doc.createTextNode("");
    else {
      if (
        (BUILD.svg && !isSvgMode && (isSvgMode = "svg" === l.$tag$),
        (a = l.$elm$ =
          BUILD.svg
            ? doc.createElementNS(
                isSvgMode
                ...
                BUILD.slotRelocation && 2 & l.$flags$ ? "slot-fb" : l.$tag$,
              )
            : doc.createElement(
                BUILD.slotRelocation && 2 & l.$flags$ ? "slot-fb" : l.$tag$,
              )),
        BUILD.svg &&
          ...
          "foreignObject" === l.$tag$ &&
          (isSvgMode = !1),
        BUILD.vdomAttribute && updateElement(null, l, isSvgMode),
        (BUILD.shadowDom || BUILD.scoped) &&
          null != scopeId &&
          a["s-si"] !== scopeId &&
          a.classList.add((a["s-si"] = scopeId)),
        l.$children$)
      )
        for (d = 0; d < l.$children$.length; ++d)
          (r = createElm(e, l, d, a)), r && a.appendChild(r);
      BUILD.svg &&
        ("svg" === l.$tag$
          ? (isSvgMode = !1)
          : "foreignObject" === a.tagName && (isSvgMode = !0));
    }
    return (
      (a["s-hn"] = hostTagName),
      BUILD.slotRelocation &&
        ...
        (a["s-cr"] = contentRef),
        (a["s-sn"] = l.$name$ || ""),
        (a["s-rf"] = null === (s = l.$attrs$) || void 0 === s ? void 0 : s.ref),
        (i = e && e.$children$ && e.$children$[o]),
        i &&
          i.$tag$ === l.$tag$ &&
          e.$elm$ &&
  ...
  putBackInOriginalLocation = (e, t) => {
    ...
    if (e["s-sr"] && BUILD.experimentalSlotFixes) {
      let t = e;
      for (; (t = t.nextSibling); )
        t && t["s-sn"] === e["s-sn"] && t["s-sh"] === hostTagName && o.push(t);
    }
            ...
            if (!BUILD.experimentalSlotFixes || (o && 1 === o.nodeType)) {
              ...
              for (; l; ) {
                ...
                if (n && n["s-sn"] === t["s-sn"] && e === n.parentNode) {
                  for (
                    n = n.nextSibling;
                    n === t || (null == n ? void 0 : n["s-sr"]);

                  )
                    n = null == n ? void 0 : n.nextSibling;
                  if (!n || !n["s-nr"]) {
                    o = n;
                    break;
                  }
...
const callRender = (e, t, o, n) => {
  ...
  initializeComponent = async (e, t, o, n) => {
    ...
    if (!(32 & t.$flags$)) {
      ...
      if ((BUILD.lazyLoad || BUILD.hydrateClientSide) && n) {
    ...
    (e.__appendChild = e.appendChild),
      (e.appendChild = function (e) {
        const t = (e["s-sn"] = getSlotName(e)),
          o = getHostSlotNode(this.childNodes, t, this.tagName);
        if (o) {
          const n = getHostSlotChildNodes(o, t),
            s = n[n.length - 1],
            l = s.parentNode.insertBefore(e, s.nextSibling);
          return updateFallbackSlotVisibility(this), l;
        }
    ...
    e.prepend = function (...e) {
      e.forEach((e) => {
        ...
        const o = (e["s-sn"] = getSlotName(e)),
          n = getHostSlotNode(this.childNodes, o, this.tagName);
        if (n) {
    ...
    Object.defineProperty(e, "__textContent", t),
      BUILD.experimentalScopedSlotChanges
        ...
        : Object.defineProperty(e, "textContent", {
            ...
            set(e) {
              var t;
              const o = getHostSlotNode(this.childNodes, "", this.tagName);
              if (
                3 ===
  ...
  getHostSlotNode = (e, t, o) => {
    let n,
      s = 0;
    for (; s < e.length; s++) {
      if (((n = e[s]), n["s-sr"] && n["s-sn"] === t && n["s-hn"] === o))
        return n;
      if (((n = getHostSlotNode(n.childNodes, t, o)), n)) return n;
    }
    return null;
  },
